...
class InputManager(_object):
    ...
    def KeyReleased(self, *args): return _ugdk_input.InputManager_KeyReleased(self, *args)
    ...
    def MouseReleased(self, *args): return _ugdk_input.InputManager_MouseReleased(self, *args)
